...
TEST_CASE( "Test constructors", "[atom]" ) {
...

  {
    ...
    Atom a("hi");
    Atom b(1.0);
    Atom f(std::complex<double> (12.3,4));
...
TEST_CASE( "Test assignment", "[atom]" ) {
...

  {
    ...
    Atom a;
    Atom b(std::complex<double>(12,3));
    b = a;
    REQUIRE(b.isNone());
    REQUIRE(!b.isNumber());
    REQUIRE(!b.isSymbol());
...

  {
    ...
    Atom a(std::complex<double>(12,3));
    Atom b(1.0);
    b = a;
    REQUIRE(b.isComplex());
    REQUIRE(b.asComplex() == std::complex<double>(12,3));
  }
...
TEST_CASE( "test comparison", "[atom]" ) {
...

  {
    ...
    Atom a(std::complex<double>(12,3));
    Atom b(std::complex<double>(12,3));
    Atom c(std::complex<double>(12,4));
    REQUIRE(a != c);
    REQUIRE(a == b);
  }
